            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <Button
                        variant="outline"
                        size="sm"
                        className="gap-2 rounded-none h-10 px-4 border-border/60"
                        asChild
                    >
                    ...
                    <Button
                        variant="accent"
                        size="sm"
                        className="gap-2 rounded-none h-10 px-6 shadow-lg shadow-tangerine/20"
                        asChild
                    >
                ...
                <Card className="lg:col-span-2 rounded-none border-border/40 shadow-sm">
                    <CardHeader className="flex flex-row items-center justify-between border-b border-border/40 py-4">
                        ...
                        <Button
                            variant="ghost"
                            size="sm"
                            className="text-tangerine hover:text-tangerine hover:bg-tangerine/5"
                            asChild
                        >
                            <Link
                            ...
                            {isLoading
                                ? Array(5)
                                      ...
                                      .map((_, i) => (
                                          <div
                                              key={i}
                                              className="flex items-start gap-4 p-3 animate-pulse"
                                          >
                ...
                <div className="space-y-6">
                            ...
                            <div className="grid divide-y divide-border/40">
                                <div className="flex items-center justify-between p-4 hover:bg-muted/30 transition-colors">
                                    ...
                                    <div className="text-xs font-bold text-foreground bg-blue-500/5 px-2 py-1 border border-blue-500/10">
                                        {isLoading
                                            ? '...'
                                            : `${dashboardData?.deals.total} ACTIVE DEALS`}
                                    </div>
                                </div>
                                <div className="hidden flex items-center justify-between p-4 hover:bg-muted/30 transition-colors">
                                    <div className="flex items-center gap-3">
                                    ...
                                    <div className="text-right">
                                        <div className="text-xs font-bold text-foreground bg-tangerine/5 px-2 py-1 border border-tangerine/10">
                                            {isLoading
                                                ? '...'
                                                : `${dashboardData?.campaigns.active} RUNNING`}
                                        </div>
                                    </div>
                                </div>
                                <div className="hidden flex items-center justify-between p-4 hover:bg-muted/30 transition-colors">
                                    ...
                                    <div className="text-right">
                                        <div className="text-xs font-bold text-foreground bg-purple-500/5 px-2 py-1 border border-purple-500/10">
                                            {isLoading
                                                ? '...'
                                                : `${dashboardData?.workflows.runs} TOTAL RUNS`}
                                        </div>
                                    </div>
                                </div>
                                <div className="hidden flex items-center justify-between p-4 hover:bg-muted/30 transition-colors">
                                    ...
                                    <div className="text-xs font-bold text-foreground bg-green-500/5 px-2 py-1 border border-green-500/10">
                                        {isLoading
                                            ? '...'
                                            : `${dashboardData?.seo.projects} PROJECTS`}
                                    </div>
                                </div>
                            </div>
                        </CardContent>
                    ...
                    <Card className="rounded-none border-tangerine/20 bg-tangerine/[0.02] relative overflow-hidden group shadow-md">
                        ...
                        <CardContent className="p-6 relative z-10">
                            ...
                            <Button
                                size="sm"
                                className="w-full mt-6 bg-tangerine hover:bg-tangerine/90 text-white border-none shadow-lg shadow-tangerine/20 rounded-none font-bold uppercase tracking-wider h-10 group"
                                asChild
                            >
                                <Link href="/dashboard/intelligence">
                                    Enrich Now
