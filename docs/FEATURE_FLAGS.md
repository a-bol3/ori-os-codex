...
| `ENABLE_GMAIL_INTEGRATION` | Enables the server-side, read-only Gmail integration foundation. | `OFF` | `OFF` |
| `NEXT_PUBLIC_ENABLE_GMAIL_INTEGRATION` | Displays the controlled Gmail connection and status UI. | `OFF` | `OFF` |
